...
Pokemon::Pokemon()
{
	...
	//个体值在0~31随机，基础点数置零
	Str.BaseStats = 0;
	Str.IndividualValue = rand() % 32;
	Int.BaseStats = 0;
	Int.IndividualValue = rand() % 32;
	Phy.BaseStats = 0;
	Phy.IndividualValue = rand() % 32;
	Sta.BaseStats = 0;
	Sta.IndividualValue = rand() % 32;
	Res.BaseStats = 0;
	Res.IndividualValue = rand() % 32;
	Agi.BaseStats = 0;
	Agi.IndividualValue = rand() % 32;
